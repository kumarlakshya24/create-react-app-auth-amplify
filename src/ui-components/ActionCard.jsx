...
import { PopularItems } from "../models";
import { schema } from "../models/schema";
import { Button, Flex, Image, Rating, Text } from "@aws-amplify/ui-react";
export default function ActionCard(props) {
  const { popularItems, overrides, ...rest } = props;
  const dollarNineNineUSDOnClick = useDataStoreUpdateAction({
    fields: {},
    id: popularItems?.Count,
    model: PopularItems,
    schema: schema,
  });
  return (
